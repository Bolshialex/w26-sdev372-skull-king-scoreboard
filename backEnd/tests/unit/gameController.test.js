...
describe("Game Controller", () => {
  ...
  describe("createGame", () => {
    it("should create a game and return 201", async () => {
      ...
      const playerGameCreate = vi
        .spyOn(PlayerGame, "create")
        .mockResolvedValue({ id: 1 });
      const roundCreate = vi
        .spyOn(Round, "create")
        .mockResolvedValue(rounds[0]);
      ...
      expect(playerGameCreate).toHaveBeenNthCalledWith(2, {
        game_id: games[0].id,
        player_id: 2,
      });
  ...
  describe("startNewRound", () => {
    it("should create player rounds and return 201 when round_number is 1", async () => {
      ...
      const roundCreate = vi
        .spyOn(Round, "create")
        .mockResolvedValue({ id: 203, round_number: 2, game_id: games[0].id });
    ...
    it("should create player rounds and return 201 when round_number is not 1", async () => {
      ...
      const roundCreate = vi
        .spyOn(Round, "create")
        .mockResolvedValue({ id: 203, round_number: 3, game_id: games[0].id });
